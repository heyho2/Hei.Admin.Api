...
namespace Hei.Admin.Core.Encrypt
{
    ...
    public class DesEncrypt
    {
        ...
        private static readonly byte[] key = Encoding.ASCII.GetBytes(KEY.Substring(0, 8));
        private static readonly byte[] iv = Encoding.ASCII.GetBytes(KEY.Insert(0, "w").Substring(0, 8));
